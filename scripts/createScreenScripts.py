...
for i, d in enumerate(data):
    ...
    with open("105/%03d.sh"%node_i,'a') as f:
        f.write("python3 /home/karolmajek/tensorflow/models/research/object_detection/model_tpu_main.py --pipeline_config_path=%spipeline.config --model_dir=%s --num_train_steps=50000 --sample_1_of_n_eval_examples=1 --alsologtostderr --tpu_name=%s &> logs/105_20181026/%s_%08d\n"%(d,d.replace('configs','logs/105_20181026/'+nodes[node_i]),nodes[node_i],nodes[node_i],i))
